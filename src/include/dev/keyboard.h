...
ENUM_SET(KeyCodes, CapsLock, 0x0A),
ENUM_SET(KeyCodes, NumLock, 0x0B),
ENUM_SET(KeyCodes, Control, 0x0C),
ENUM_SET(KeyCodes, Alt, 0x0D),
ENUM_SET(KeyCodes, Meta, 0x0E),
ENUM_SET(KeyCodes, Insert, 0x0F),
ENUM_SET(KeyCodes, AltGr, 0x10),
ENUM_SET(KeyCodes, Menu, 0x11),
ENUM_SET(KeyCodes, UpArrow, 0x12),
ENUM_SET(KeyCodes, DownArrow, 0x13),
ENUM_SET(KeyCodes, LeftArrow, 0x14),
ENUM_SET(KeyCodes, RightArrow, 0x15),
ENUM_SET(KeyCodes, Shift, 0x16),
