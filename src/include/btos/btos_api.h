...
enum{
	...
	BT_MSGQUERY			= 0x090B,
	BT_MAKE_MSG_WAIT	= 0x090C,
	BT_READ_MSG_WAIT	= 0x090D,
	
	BT_CLOSEHANDLE      = 0x0A01,
	BT_QUERYHANDLE		= 0x0A02,
	BT_WAITHANDLE		= 0x0A03,
