...
inline static bt_handle_t bt_create_shm(uint32_t flags){
...
inline static bt_handle_t bt_shm_map(uint64_t id, void *addr, uint32_t offset, size_t pages, uint32_t flags){
