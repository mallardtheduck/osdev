...
public:
	SessionType() = default;
	SessionType(const std::string &id, const std::string &n, const std::string &l, const std::vector<std::string> &s);
	...
	std::vector<std::string> GetAutoServices() const;
