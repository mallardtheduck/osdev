...
enum opt_code
{
  ...
  OPT_march_ = 1056,                         /* -march= */
  OPT_masm_ = 1057,                          /* -masm= */
  OPT_mavx = 1058,                           /* -mavx */
  OPT_mavx2 = 1059,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1060,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1061,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1062,                           /* -mbmi */
  OPT_mbmi2 = 1063,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1064,                  /* -mbranch-cost= */
  OPT_mcld = 1065,                           /* -mcld */
  OPT_mcmodel_ = 1066,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1067, */                    /* -mcpu= */
  OPT_mcrc32 = 1068,                         /* -mcrc32 */
  OPT_mcx16 = 1069,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1070,            /* -mdispatch-scheduler */
  OPT_mf16c = 1071,                          /* -mf16c */
  OPT_mfancy_math_387 = 1072,                /* -mfancy-math-387 */
  OPT_mfentry = 1073,                        /* -mfentry */
  OPT_mfma = 1074,                           /* -mfma */
  OPT_mfma4 = 1075,                          /* -mfma4 */
  OPT_mforce_drap = 1076,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1077,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1078,                       /* -mfpmath= */
  OPT_mfsgsbase = 1079,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1080, */              /* -mfused-madd */
  OPT_mfxsr = 1081,                          /* -mfxsr */
  OPT_mhard_float = 1082,                    /* -mhard-float */
  OPT_mhle = 1083,                           /* -mhle */
  OPT_mieee_fp = 1084,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1085,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1086,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1087,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1088, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1089,         /* -mlarge-data-threshold= */
  OPT_mlong_double_64 = 1090,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1091,                /* -mlong-double-80 */
  OPT_mlwp = 1092,                           /* -mlwp */
  OPT_mlzcnt = 1093,                         /* -mlzcnt */
  OPT_mmmx = 1094,                           /* -mmmx */
  OPT_mmovbe = 1095,                         /* -mmovbe */
  OPT_mms_bitfields = 1096,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1097,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1098,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1099,                  /* -mno-push-args */
  OPT_mno_red_zone = 1100,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1101,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1102,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1103,                          /* -mpc32 */
  OPT_mpc64 = 1104,                          /* -mpc64 */
  OPT_mpc80 = 1105,                          /* -mpc80 */
  OPT_mpclmul = 1106,                        /* -mpclmul */
  OPT_mpopcnt = 1107,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1108,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1109,     /* -mpreferred-stack-boundary= */
  OPT_mprfchw = 1110,                        /* -mprfchw */
  OPT_mpush_args = 1111,                     /* -mpush-args */
  OPT_mrdrnd = 1112,                         /* -mrdrnd */
  OPT_mrdseed = 1113,                        /* -mrdseed */
  OPT_mrecip = 1114,                         /* -mrecip */
  OPT_mrecip_ = 1115,                        /* -mrecip= */
  OPT_mred_zone = 1116,                      /* -mred-zone */
  OPT_mregparm_ = 1117,                      /* -mregparm= */
  OPT_mrtd = 1118,                           /* -mrtd */
  OPT_mrtm = 1119,                           /* -mrtm */
  OPT_msahf = 1120,                          /* -msahf */
  OPT_msoft_float = 1121,                    /* -msoft-float */
  OPT_msse = 1122,                           /* -msse */
  OPT_msse2 = 1123,                          /* -msse2 */
  OPT_msse2avx = 1124,                       /* -msse2avx */
  OPT_msse3 = 1125,                          /* -msse3 */
  OPT_msse4 = 1126,                          /* -msse4 */
  OPT_msse4_1 = 1127,                        /* -msse4.1 */
  OPT_msse4_2 = 1128,                        /* -msse4.2 */
  OPT_msse4a = 1129,                         /* -msse4a */
  /* OPT_msse5 = 1130, */                    /* -msse5 */
  OPT_msseregparm = 1131,                    /* -msseregparm */
  OPT_mssse3 = 1132,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1133,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1134,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1135,            /* -mstringop-strategy= */
  OPT_mtbm = 1136,                           /* -mtbm */
  OPT_mtls_dialect_ = 1137,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1138,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1139,                         /* -mtune= */
  OPT_mveclibabi_ = 1140,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1141,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1142,                    /* -mvzeroupper */
  OPT_mx32 = 1143,                           /* -mx32 */
  OPT_mxop = 1144,                           /* -mxop */
  OPT_mxsave = 1145,                         /* -mxsave */
  OPT_mxsaveopt = 1146,                      /* -mxsaveopt */
  OPT_n = 1147,                              /* -n */
  OPT_no_canonical_prefixes = 1148,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1149,              /* -no-integrated-cpp */
  OPT_nocpp = 1150,                          /* -nocpp */
  OPT_nodefaultlibs = 1151,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1152,                   /* -nostartfiles */
  OPT_nostdinc = 1153,                       /* -nostdinc */
  OPT_nostdinc__ = 1154,                     /* -nostdinc++ */
  OPT_nostdlib = 1155,                       /* -nostdlib */
  OPT_o = 1156,                              /* -o */
  OPT_p = 1157,                              /* -p */
  OPT_pass_exit_codes = 1158,                /* -pass-exit-codes */
  /* OPT_pedantic = 1159, */                 /* -pedantic */
  OPT_pedantic_errors = 1160,                /* -pedantic-errors */
  OPT_pg = 1161,                             /* -pg */
  OPT_pie = 1162,                            /* -pie */
  OPT_pipe = 1163,                           /* -pipe */
  OPT_print_file_name_ = 1164,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1165,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1166,          /* -print-multi-directory */
  OPT_print_multi_lib = 1167,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1168,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1169,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1170,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1171,               /* -print-prog-name= */
  OPT_print_search_dirs = 1172,              /* -print-search-dirs */
  OPT_print_sysroot = 1173,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1174,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1175,                          /* -quiet */
  OPT_r = 1176,                              /* -r */
  ...
  /* OPT_std_c__03 = 1194, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1195, */                /* -std=c++0x */
  OPT_std_c__11 = 1196,                      /* -std=c++11 */
  OPT_std_c__1y = 1197,                      /* -std=c++1y */
  OPT_std_c__98 = 1198,                      /* -std=c++98 */
  OPT_std_c11 = 1199,                        /* -std=c11 */
  /* OPT_std_c1x = 1200, */                  /* -std=c1x */
  /* OPT_std_c89 = 1201, */                  /* -std=c89 */
  OPT_std_c90 = 1202,                        /* -std=c90 */
  OPT_std_c99 = 1203,                        /* -std=c99 */
  /* OPT_std_c9x = 1204, */                  /* -std=c9x */
  OPT_std_f2003 = 1205,                      /* -std=f2003 */
  OPT_std_f2008 = 1206,                      /* -std=f2008 */
  OPT_std_f2008ts = 1207,                    /* -std=f2008ts */
  OPT_std_f95 = 1208,                        /* -std=f95 */
  OPT_std_gnu = 1209,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1210, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1211, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1212,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1213,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1214,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1215,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1216, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1217, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1218,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1219,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1220, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1221, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1222,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1223, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1224, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1225, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1226,                     /* -std=legacy */
  OPT_symbolic = 1227,                       /* -symbolic */
  OPT_t = 1228,                              /* -t */
  OPT_time = 1229,                           /* -time */
  OPT_time_ = 1230,                          /* -time= */
  OPT_traditional = 1231,                    /* -traditional */
  OPT_traditional_cpp = 1232,                /* -traditional-cpp */
  OPT_trigraphs = 1233,                      /* -trigraphs */
  OPT_u = 1234,                              /* -u */
  OPT_undef = 1235,                          /* -undef */
  OPT_v = 1236,                              /* -v */
  OPT_version = 1237,                        /* -version */
  OPT_w = 1238,                              /* -w */
  OPT_wrapper = 1239,                        /* -wrapper */
  OPT_x = 1240,                              /* -x */
  OPT_z = 1241,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
