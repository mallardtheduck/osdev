...
extern enum attr_isa get_attr_isa (rtx);
...
extern enum attr_btver2_decode get_attr_btver2_decode (rtx);

#define HAVE_ATTR_btver2_sse_attr 1
extern enum attr_btver2_sse_attr get_attr_btver2_sse_attr (rtx);
