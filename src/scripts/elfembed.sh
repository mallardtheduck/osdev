...
echo "#endif" >> $HEADER
echo "" >> $HEADER
echo "__attribute__((unused)) static const char *const ${VARNAME}_data = &$SYM_START;" >> $HEADER
echo "__attribute__((unused)) static const size_t ${VARNAME}_size = (size_t)&$SYM_SIZE;" >> $HEADER
echo "" >> $HEADER
