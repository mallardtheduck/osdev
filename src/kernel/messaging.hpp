...
bool msg_recv(btos_api::bt_msg_header &msg, bt_pid_t pid=proc_current_pid);
btos_api::bt_msg_header msg_recv_block(bt_pid_t pid=proc_current_pid);
...
btos_api::bt_msg_header msg_recv_filtered(btos_api::bt_msg_filter filter, bt_pid_t pid=proc_current_pid, bool block=true);
...
void msg_subscribe(btos_api::bt_kernel_messages::Enum message, bt_pid_t pid=proc_current_pid);
void msg_unsubscribe(btos_api::bt_kernel_messages::Enum, bt_pid_t pid=proc_current_pid);
