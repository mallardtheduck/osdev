...
void proc_set_latest_msg(btos_api::bt_msg_header *msg, pid_t pid=proc_current_pid);
btos_api::bt_msg_header *proc_get_latest_msg(pid_t pid=proc_current_pid);
btos_api::bt_msg_header *proc_get_latest_msg_nolock(pid_t pid=proc_current_pid);
