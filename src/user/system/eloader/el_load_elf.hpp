...
entrypoint load_elf_proc(btos_api::bt_handle_t file, const char *path);
uint32_t load_elf_library(btos_api::bt_handle_t file, const char *name, const char *full_path, bool dynamic = false);
